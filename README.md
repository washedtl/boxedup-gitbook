---
description: The BoxedUp Discord's complete Amazon seller & sourcing playbook — from your first scan to running a real reseller business.
...
|---|---|---|
| 🟢 **Beginner** | Brand-new to Amazon. No account yet, or just opened one. | [Pro vs Individual: which plan](seller-account/pro-vs-individual.md) |
| 🟡 **Intermediate** | Selling actively but stuck under \$10K/mo, or want to graduate from RA to OA/wholesale. | [Building a sourcing routine that scales](sourcing/sourcing-routine.md) |
| 🔴 **Advanced** | Scaling, hiring preppers, building tooling, fighting hijackers. | [Reimbursements playbook](seller-central/reimbursements.md) |
...
**Ready?** Start with [How to use this guide →](getting-started/how-to-use.md)
